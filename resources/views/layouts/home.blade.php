				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="signin-form">
							...
							<form action="{{ route('login') }}" id="frmSignIn" method="post">
								...
								<div class="row">
									<div class="form-group">
										<div class="col-md-12 p-none">
											<a class="pull-right mt-none p-none" id="headerRecover" href="#">(Lost
												Password?)</a>
							...
							<p class="sign-up-info">Don't have an account yet? <a href="#" id="headerSignUp"
									class="p-none m-none ml-xs">Sign Up</a></p>
						...
						<div class="signup-form">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											...
											<input id="password-confirm" type="password" value=""
												class="form-control input-lg" name="password_confirmation" required>
										</div>
									</div>
								</div>
								<div class="row">
							...
							<p class="log-in-info">Already have an account? <a href="#" id="headerSignIn"
									class="p-none m-none ml-xs">Log In</a></p>
						</div>

						<div class="recover-form">
							<span class="dropdown-mega-sub-title">Reset My Password</span>
							<p>Complete the form below to receive an email with the authorization code needed to reset
								your password.</p>
									...
									<div class="form-group">
										<div class="col-md-12">
											...
											<input id="email2" type="text" value=""
												class="form-control input-lg{{ $errors->has('email2') ? ' is-invalid' : '' }}"
												name="email2" value="{{ $email ?? old('email2') }}" required autofocus>
							...
							<p class="log-in-info">Already have an account? <a href="#" id="headerRecoverCancel"
									class="p-none m-none ml-xs">Log In</a></p>
						</div>
						...
						<span class="thumb-info thumb-info-lighten thumb-info-bottom-info thumb-info-centered-icons">
							<span class="thumb-info-wrapper">
								...
								<span class="thumb-info-title">
									<span
										class="thumb-info-inner font-size-xs line-height-xs pt-xs">{{$item['title_test']}}</span>
